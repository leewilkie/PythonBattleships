...
class Renderer:
    ...
    def _draw_game_over(self, game: Game) -> None:
        ...
        text = "YOU WIN!" if game.state == GameState.HUMAN_WON else "COMPUTER WINS!"
